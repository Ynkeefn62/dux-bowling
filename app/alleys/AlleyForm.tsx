  ...
  if (done) {
    return (
      <div className="card" style={{ borderColor: '#6b3a1e', textAlign: 'center', padding: '46px 20px' }}>
        <h2 className="stripe sec" style={{ color: 'var(--orange)' }}>Thank you.</h2>
        <p className="lede" style={{ margin: '12px auto 0' }}>
          Your answers are on our lane. If you said you would meet, Andrew will reach out personally — duckpin&apos;s
          future is getting built with operators like you.
        </p>
      </div>
    );
  }
