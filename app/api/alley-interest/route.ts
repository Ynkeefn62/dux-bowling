...
export async function POST(req: Request) {
  ...
  const row = {
    ...
    replace_timing: str(body.replace_timing) || null,
    price_expectation: str(body.price_expectation) || null,
    software_interest: str(body.software_interest) || null,
    feedback_culture: str(body.feedback_culture) || null,
    role_other: str(body.role_other, 80) || null,
    zip: str(body.zip, 10) || null,
