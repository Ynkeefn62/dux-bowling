...
function NeonDux() {
  return (
    ...
    >
      ...
      <g className="lt d"><rect width="341" height="120" fill="#e8834a" mask="url(#md)" /></g>
      <g className="lt u"><rect width="341" height="120" fill="#e8834a" mask="url(#mu)" /></g>
      <g className="lt x"><rect width="341" height="120" fill="#e8834a" mask="url(#mx)" /></g>
    </svg>
  );
}
    ...
    <main>
      <div className="wrap">
        <div className="hero-wrap">
          <div>
            <NeonDux />
            <div className="wordmark">BOWLING</div>
