...
function NeonSign() {
  return (
    <div className="sign">
      <svg className="neon" viewBox="0 0 341 204" role="img" aria-label="Dux Bowling">
        <defs>
        ...
        <g className="lt lt-d"><rect width="341" height="204" fill="#f5823e" mask="url(#md)" /></g>
        <g className="lt lt-u"><rect width="341" height="204" fill="#f5823e" mask="url(#mu)" /></g>
        <g className="lt lt-x"><rect width="341" height="204" fill="#f5823e" mask="url(#mx)" /></g>
        <g className="bw" transform="translate(8 158)" fill="none" stroke="#efe2c4" strokeWidth="8"
           strokeLinecap="round" strokeLinejoin="round">
          <path d="M4 4 V36" />
          <path d="M4 4 H16 A8 8 0 0 1 16 20 H4" />
          <path d="M16 20 A8 8 0 0 1 16 36 H4" />
          <path d="M52 20 A16 16 0 1 0 84 20 A16 16 0 1 0 52 20" />
          <path d="M112 4 L119 36 L126 12 L133 36 L140 4" />
          <path d="M168 4 V36 H186" />
          <path d="M212 4 V36" />
          <path d="M240 36 V4 L262 36 V4" />
